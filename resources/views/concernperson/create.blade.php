...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Concern Person Setup Form') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('/addconcernperson') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror" rows="3" name="description" placeholder="Type Description here ..."></textarea>
