...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('MRA Information Edit Form') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('/editmraform/'.$mraforms->id) }}" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <input id="invoice" type="text" class="form-control @error('invoice') is-invalid @enderror" name="invoice" value="{{ $mraforms->invoice }}" required  readonly>                                                         
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">                           
                                ...
                                @foreach ($paymentlists as $paymentlists)                                     
                                      <option value="{{ $paymentlists->id }}" @if($paymentlists->id== $mraforms->payment_type) selected='selected' @endif >{{ $paymentlists->name }}</option> 
                                @endforeach   
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <textarea id="purpose" class="form-control @error('purpose') is-invalid @enderror" rows="3" name="purpose" placeholder="Type purpose here ...">{{ $mraforms->purpose }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ $mraforms->amount }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <input id="grand_total" type="text" class="form-control @error('grand_total') is-invalid @enderror" name="grand_total" value="{{ $mraforms->grand_total }}" required  readonly>                                                         
                            <!--  <input id="grand_total" type="hidden" class="form-control @error('building_id') is-invalid @enderror" name="building_id" value="" required  readonly>-->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <textarea id="word" class="form-control @error('address') is-invalid @enderror" rows="3" name="word" placeholder="Type word here ..." required readonly>{{ $mraforms->word }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                            <textarea id="remarks" class="form-control @error('remarks') is-invalid @enderror" rows="3" name="remarks" placeholder="Type remarks here ...">{{ $mraforms->remarks }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">                           
                                ...
                                @foreach ($pbpeoplelists as $pbpeoplelist)                                     
                                      <option value="{{ $pbpeoplelist->id }}" @if($pbpeoplelist->id== $mraforms->prepared_by) selected='selected' @endif >{{ $pbpeoplelist->name }}</option>
                                @endforeach
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">                           
                                ...
                                @foreach ($vbpeoplelists as $vbpeoplelist)                                      
                                      <option value="{{ $vbpeoplelist->id }}" @if($vbpeoplelist->id== $mraforms->varified_by) selected='selected' @endif >{{ $vbpeoplelist->name }}</option>
                                @endforeach
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-file">                                   
                                    ...
                                    <label for="document" >{{ $mraforms->document }}</label> 
                                </div>                             
                                @error('document')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
